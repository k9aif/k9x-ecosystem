      ...
      <div className="intake-form">
        ...
        <div className="intake-row-2">
          ...
          <div className="intake-field">
            ...
            <input
              className="intake-input"
              placeholder="e.g. Enterprise Claims Processor"
              value={(project as any).app_name ?? ''}
        ...
        <div className="intake-row-2">
          <div className="intake-field">
            ...
            <input
              className="intake-input"
              placeholder="e.g. Insurance / Banking / Healthcare"
        ...
        <div className="intake-field">
          ...
          <textarea
            ...
            placeholder="What is the desired end-state? What business problem does this solve?"
            value={(project as any).vision ?? ''}
        ...
        <div className="intake-field">
          ...
          <textarea
            className="intake-textarea"
            placeholder="Describe the current process, pain points, and limitations"
            value={(project as any).current_state ?? ''}
        ...
        <div className="intake-field">
          ...
          <textarea
            className="intake-textarea"
            placeholder="Key pain points, blockers, and frustrations with the current state"
            value={(project as any).pain_points ?? ''}
        ...
        <div className="intake-field">
          ...
          <textarea
            className="intake-textarea"
            placeholder="Key objectives, KPIs, and success metrics"
            value={(project as any).target_goals ?? ''}
            onChange={(e) => set('target_goals', e.target.value)}
            rows={3}
          />
        </div>
        ...
        <div className="intake-field">
          ...
          <textarea
            className="intake-textarea"
            placeholder="Additional context — stakeholders, constraints, compliance requirements, systems of record, preferred models, anything relevant..."
            value={(project as any).notes ?? ''}
